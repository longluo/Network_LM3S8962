...
** Descriptions:            Initializes the system architecture layer.                                  **     
...
** Descriptions:            Creat a new mailbox                                                          **     
** input parameters:       size is the number of entries in the mailbox                                                                       **
** output parameters:       none                                                                        **
** Returned value:          the handle of the created mailbox.                                                                        **
==========================================================================================================
** Created by:              long.luo                                                                    **
** Created Date:            10-04-2013                                                                  **
*********************************************************************************************************/ 
